...
- Get your [Necessary Variables](https://github.com/JIYOXC/XCRYXMUSIC/blob/master/sample.env)
...
`git clone https://github.com/JIYOXC/XCRYXMUSIC && cd XCRYXMUSIC`
...
`bash start`
- For getting out from screen session : Press `Ctrl+a` and then `d`<br>
━━━━━━━━━━━━━━━━━━━━
